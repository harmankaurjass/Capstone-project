    ...
    render() {
        ...
        return (
            <div>
                ...
                <nav className="navbar navbar-expand-lg navbar-dark  pt-3 pb-3" id="navbar23">
                    <Link className="navbar-brand" to="/"><i className="fa fa-book text-warning "></i> <span style={{ color: 'orange' }}>Book Store</span></Link>
