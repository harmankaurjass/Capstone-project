...
module.exports = {
    ...
    makePayment: async (req, res, next) => {
        ...
        let msgPart1 = `<!DOCTYPE html>
                        ...
                        <h2 class="text-center mb-5"><i class="fa fa-book text-dark "></i> <span style="color:orange;" >Book Store</span></h2>
                        <p class="font-italic">Greetings from our Book Store.</p>
                        <p class="font-italic">Your order has been confirmed and will be delivered to you within 3 business days.</p>
                        <div class="container">
                            <div class="row">
        ...
        let msgPart2 = `</tbody>
                ...
                <p class="font-italic">For more info contact info@bookstore.com</p>
                </div>
                </div>
                </body>
                </html>`;
        ...
        try {
            return stripe.customers.create({
                ...
                stripe.charges.create({
                    ...
                    description: `Purchase of books from Book Store`,
                }, { idempotencyKey })
            }).then(async (result) => {
